...
EOF;
                         if($this->auth->is_user($content['uid']) || $this->auth->is_admin() || $this->auth->is_master($cate['node_id'])){?>
                    ...
                    <div class="panel-body">
						...
						<input name="lastpost" id="lastpost" type="hidden" value="<?php echo $myinfo['lastpost']?>" />
                            <div class="form-group">
                                ...
                                <span type="button" id="add-pre" class="btn btn-default">代码</span>
								<?php if($this->config->item('storage_set')=='local'){?>
...
$("#add-pre").click(function(){
    $("#post_content").val($("#post_content").val()+'<pre></pre>');
});
</script>