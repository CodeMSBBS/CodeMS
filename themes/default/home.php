                ...
                <div class="panel">
                    <div class="panel-heading" style="height: 45px;">
                    	<ul class="nav nav-pills">
				            ...
				            <li><a href="<?php echo url('tag_show','',$v['tag_title']);?>" style="font-size:14px;padding:3px 5px;color:#353535"><?php echo $v['tag_title'];?></a></li>
							<?php }?>
                    	</ul>
                    </div>
                    <div class="panel-body">
                     ...
                     <div class="panel-footer"><a href="javascript:void(0)" id="getmore" class="startbbs">更多新主题</a><span title="通过 Atom Feed 订阅" style="float:right;"><img src="<?php echo site_url().'static/common/images/rss.png'?>" alt=""><a href="<?php echo site_url('feed'); ?>" target="_blank" style="color:#464444">通过 Atom Feed 订阅</a></span></div>
                </div><!-- /.topic list -->
