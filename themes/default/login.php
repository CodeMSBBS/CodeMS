            ...
            <div class="col-md-8">
                <div class="panel panel-default">
					...
					<div class="form-group">
						<label class="col-md-2 control-label" for="user_nickname" style="width:18%">用户名/邮箱</label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<label class="col-md-2 control-label" for="user_password" style="width:18%">密码</label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<label class="col-md-2 control-label" for="captcha_code" style="width:18%">验证码</label>
						<div class="col-md-4">
